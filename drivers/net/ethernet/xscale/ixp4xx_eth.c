...
static int hwtstamp_set(struct net_device *netdev,
...
static int hwtstamp_get(struct net_device *netdev,
			struct kernel_hwtstamp_config *cfg)
{
	struct port *port = netdev_priv(netdev);
...
static const struct net_device_ops ixp4xx_netdev_ops = {
	...
	.ndo_hwtstamp_get = hwtstamp_get,
	.ndo_hwtstamp_set = hwtstamp_set,
};
