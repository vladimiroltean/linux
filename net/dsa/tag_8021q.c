...
EXPORT_SYMBOL_GPL(dsa_8021q_bridge_fwd_offload_tx_vid);
...
int dsa_tag_8021q_bridge_fwd_offload_add(struct dsa_switch *ds, int port,
					 ...
					 int bridge_num)
{
	u16 tx_vid = dsa_8021q_bridge_fwd_offload_tx_vid(bridge_num + 1);

	return dsa_port_tag_8021q_vlan_add(dsa_to_port(ds, port), tx_vid);
}
EXPORT_SYMBOL_GPL(dsa_tag_8021q_bridge_fwd_offload_add);
...
EXPORT_SYMBOL_GPL(dsa_tag_8021q_bridge_fwd_offload_del);
